...
const ModelInner: FC<ModelInnerProps> = ({
  ...
  useLayoutEffect(() => {
    ...
    // IMPORTANT: Reset transforms before measuring to avoid double-normalizing
    // during React StrictMode or Fast Refresh re-renders.
    g.scale.setScalar(1);
    ...
    // Measure using current (reset) transform
  ...
  }, [content, fadeIn, autoFrame, initPitch, initYaw, pivot, camera]);
