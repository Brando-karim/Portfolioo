...
const DEFAULT_ITEMS: CarouselItem[] = [
  {
    ...
    image: "/images/text-animation.jpg",
  },
  {
    title: "Animations",
          ...
          return (
            <motion.div
              ...
              className={`relative shrink-0 flex flex-col overflow-hidden cursor-grab active:cursor-grabbing ${
                round ? "items-center justify-center text-center" : "items-start justify-between rounded-[12px]"
              }`}
              style={{
                width: itemWidth,
            ...
            >
              ...
              <div className={`${round ? "relative p-0 m-0 z-10" : "relative p-5 z-10"}`}>
