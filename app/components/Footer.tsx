    ...
    <footer className="py-16 px-4 border-t border-border/30">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex justify-center items-center gap-6 mb-8">
          ...
          <a href="mailto:karimbenjelloul1@gmail.com" className="group">
            <div className="w-12 h-12 bg-card rounded-full flex items-center justify-center border border-border hover:border-primary transition-all duration-300 group-hover:scale-110 group-hover:bg-primary">
              <Mail size={20} className="text-muted-foreground group-hover:text-primary-foreground transition-colors duration-300" />
            </div>
          </a>
        ...
        <div className="text-center pt-8 border-t border-border">
          <p className="text-muted-foreground text-sm">
            © 2026 Karim Benjelloul. Built with React, Laravel, and modern web technologies.
          </p>
        </div>
      </div>
    </footer>
