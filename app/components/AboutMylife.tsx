...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen " id='Life'>
      <div className="container mx-auto px-4 py-4">
        {/* Main heading */}
        <h1
  ref={titleRef}
  className="text-3xl sm:text-4xl md:text-5xl font-light text-white text-center mb-20 tracking-wide opacity-0 translate-y-12"
>
  About Me
  <div className="w-24 h-1 bg-gradient-to-r from-violet-500 to-purple-500 rounded-full mx-auto mt-4 animate-pulse"></div>
        ...
        <div className="grid md:grid-cols-3 gap-12 max-w-6xl mx-auto">
          ...
          <div
            ...
            className="text-center space-y-6 opacity-0 translate-y-16 transition-all duration-1000 ease-out"
          >
            <h2 className="text-3xl font-light text-blue-400 mb-8">Past</h2>
          ...
          <div
            ...
            className="text-center space-y-6 opacity-0 translate-y-16 transition-all duration-1000 ease-out delay-200"
          >
            <h2 className="text-3xl font-light text-blue-400 mb-8">Present</h2>
            <p className="text-gray-100 leading-relaxed text-lg">
          ...
          <div
            ...
            className="text-center space-y-6 opacity-0 translate-y-16 transition-all duration-1000 ease-out delay-500"
          >
            <h2 className="text-3xl font-light text-blue-400 mb-8">Future</h2>
            <p className="text-gray-100 leading-relaxed text-lg">
